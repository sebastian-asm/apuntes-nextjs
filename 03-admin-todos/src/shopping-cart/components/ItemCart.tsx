...
import { addProductToCart, removeSingleItemCart } from '../actions/actions'
...
export default function ItemCard({ product, quantity }: Props) {
  ...
  function onRemoveItem() {
    removeSingleItemCart(product.id)
    router.refresh()
  }
